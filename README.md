...
18年加入跨平台的ffmpeg4解码库、SDL2渲染库，支持更多音频类型。  
优化媒体库模型和用户界面，并开发一系列实用功能。  
...
### 其他
* 随机点播：歌手随机点播、专辑随机点播、播放列表随机点播、列表库中的曲目随机点播、歌手库中的曲目随机点播。
...
## **发展现状**
数据层、模型层、控制层成功移植到Qt的移动端版本，正在开发竖屏UI。  
  
联网搜索和歌词功能也在探讨，但因为版权原因很难看到商用希望。
